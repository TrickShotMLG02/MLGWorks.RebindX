...
namespace MLGWorks.RebindX.Runtime.Editors
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(m_LocalizationLabel, Styles.boldLabel);
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_TitleLocalizationProperty);
                EditorGUILayout.PropertyField(m_DescriptionLocalizationProperty);
            }
        ...
        private GUIContent m_LocalizationLabel = new GUIContent("Localization");
